...
#添加文件
driver.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div[2]/a[2]/span').click()
driver.find_element_by_xpath('/html/body/div[1]/div[2]/div[2]/div[6]/div/span[1]').click()
#再次当前文件个数
inputs =driver.find_elements_by_class_name('checkbox')
ns = 0
for li in inputs:
